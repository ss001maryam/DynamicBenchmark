...
if ex~=3
    ...
    sevN=length(sevName);
    MofPenalty=csvread(strcat(exFName{ex},'/small/',Str{1}, num2str(numFun), 'Merror.csv'));
MofPenalty=[MofPenalty;csvread(strcat(exFName{ex},'/medium/',Str{1}, num2str(numFun), 'Merror.csv'))];
MofPenalty=[MofPenalty;csvread(strcat(exFName{ex},'/large/',Str{1}, num2str(numFun), 'Merror.csv'))];

MofFeasibility=csvread(strcat(exFName{ex},'/small/',Str{2}, num2str(numFun), 'Merror.csv'));
MofFeasibility=[MofFeasibility;csvread(strcat(exFName{ex},'/medium/',Str{2}, num2str(numFun), 'Merror.csv'))];
MofFeasibility=[MofFeasibility;csvread(strcat(exFName{ex},'/large/',Str{2}, num2str(numFun), 'Merror.csv'))];

MofEpsilon=csvread(strcat(exFName{ex},'/small/',Str{3}, num2str(numFun), 'Merror.csv'));
MofEpsilon=[MofEpsilon;csvread(strcat(exFName{ex},'/medium/',Str{3}, num2str(numFun), 'Merror.csv'))];
MofEpsilon=[MofEpsilon;csvread(strcat(exFName{ex},'/large/',Str{3}, num2str(numFun), 'Merror.csv'))];
...
readSumCVs.Epsilon=[readSumCVs.Epsilon;csvread(strcat(exFName{ex},'/large/',Str{3}, num2str(numFun), 'SumCVs.csv'))];
    ...
    sevN=1;
    MofPenalty=csvread(strcat(exFName{ex},'/comb/',Str{1}, num2str(numFun), 'Merror.csv'));
MofFeasibility=csvread(strcat(exFName{ex},'/comb/',Str{2}, num2str(numFun), 'Merror.csv'));
MofEpsilon=csvread(strcat(exFName{ex},'/comb/',Str{3}, num2str(numFun), 'Merror.csv'));
