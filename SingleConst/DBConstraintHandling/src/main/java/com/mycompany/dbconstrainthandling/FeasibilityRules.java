...
public class FeasibilityRules {
    ...
    public FeasibilityRules(int NP, int D, int numF, double CR, double ab[][]) {
        this.NP = NP;
        this.numF = numF;
        this.D = D;
        this.CR = CR;
 ...
 population = new ArrayList();
    ...
    public void PrintPop(List<Individual> pop) {
        for (int i = 0; i < pop.size(); i++) {
            System.out.print(i + ".-  " + "time"+t+"   "+pop.get(i).fx + "  " + pop.get(i).SumR);
            for (int j = 0; j < pop.get(i).x.length; j++) {
               System.out.print(" "+pop.get(i).x[j]);
  ...
  public void PrintPopx(List<Individual> pop) {
        for (int i = 0; i < pop.size(); i++) {
            for (int j = 0; j < pop.get(i).x.length; j++) {
               System.out.print(" "+pop.get(i).x[j]);
    ...
    public static void main(String[] args) {
        ...
        int NP = 20, frequency = 1000, D = 10, eval, numVec = 3, gen;
        ...
        String name = "Feasibility", name2 = "Best_Know";
        ...
        for (int numF = startFunc; numF <= MAX_Functions; numF++) {
            ...
            for (int r = 0; r < runs; r++) {
                ...
                FeasibilityRules DE = new FeasibilityRules(NP, D, numF, CR, ab);// A random population was created
         ...
         //my new trend:initialize pop when change is detected
