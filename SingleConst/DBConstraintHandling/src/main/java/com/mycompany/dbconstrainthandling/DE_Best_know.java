...
public class DE_Best_know {
    ...
    public DE_Best_know(int NP, int D, int numF, double CR,  double ab[][], double t) {
        this.NP = NP;
        this.numF = numF;
        this.D = D;
        this.CR = CR;
        ...
        for (int numF = startFunc; numF <= MAX_Functions; numF++) {
            ...
            for (int time = 0; time < (int) TIMEs; time++) {
                ...
                for (int r = 0; r < runs; r++) {
                    ...
                    DE_Best_know DE = new DE_Best_know(NP, D, numF, CR, ab, (double)t);// A random population was created
