...
public class EpsilonConstrained {
    ...
    public EpsilonConstrained(int NP, int D, int numF, double CR, double ab[][], double Tc) {
        this.NP = NP;
        this.numF = numF;
        this.D = D;
        this.CR = CR;       
...
List <Double> getAverage(List<Double> values){
    ...
    public static void main(String[] args) {
       int frequency = 1000; //the frequency is determined by the number of evaluations
        ...
        int NP = 20, D = 30, eval, numVec = 3, gen;
        ...
        String name = "Epsilon", name2="Best_Know";   
        ...
        for (int numF = startFunc; numF <= MAX_Functions; numF++) {
            ...
            String fileName = "dC_01";//change whether medium, large or small changes of b u want here Med for medium, Small for small, and La for large
            ...
            for (int r = 0; r < runs; r++) {
                ...
                EpsilonConstrained DE = new EpsilonConstrained(NP, D, numF, CR, ab, Tc);// A random population was created
...
*/
                ...
                //System.out.println("size "+ListMError.size());
